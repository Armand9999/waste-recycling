  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto p-8 text-center">
        ...
        {/* <div className="grid md:grid-cols-3 justify-items-center mb-8 ">
          {
            [
              { src: "/mock-recycling.jpg", alt: "Recycling", width: 600, height: 400 },
              { src: "/mock-recycling-1.jpg", alt: "Recycling", width: 600, height: 400 },
              { src: "/mock-recycling-2.jpg", alt: "Recycling", width: 600, height: 400 }
            ].map((image, index) => (
              <Image
                key={index}
                src={image.src}
...
<section className="relative h-screen w-vh overflow-hidden mb-6">
